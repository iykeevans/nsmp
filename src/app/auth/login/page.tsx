    ...
    <div className="flex py-2 pr-2 h-screen">
      <section className="xl:w-4/12 w-full">
        <div className="pt-52 w-full md:w-[400px] mx-auto px-6 md:px-0">
          <div>
            <h1 className="text-4xl font-bold mb-2 text-left">Sign in</h1>
            ...
            <button
              className="w-full bg-[#367AFF] text-white h-[50px] rounded-lg font-semibold"
              onClick={handleLogin}
            >
              Sign in
            </button>
            ...
            <button
              className="w-full border border-[#E6E8E7] text-white h-[50px] rounded-lg flex items-center justify-center gap-3"
      ...
      <section className="h-full w-8/12 rounded-2xl hidden xl:block relative">
        <Image
          className="rounded-2xl"
          objectFit="cover"
          src="/images/solar-panel-2.jpg"
